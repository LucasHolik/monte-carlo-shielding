...
const std::array<AtomicBindingEnergies, 100>
    ScofieldPhotoelectricData::BINDING_ENERGIES = {
        {// Z=1: Hydrogen
         ...
         {10.367, 1.299, 1.143, 1.117, 0.159},
         {11.103, 1.414, 1.248, 1.217, 0.180},
         {11.867, 1.527, 1.359, 1.323, 0.202},
         {12.658, 1.652, 1.476, 1.436, 0.229},
         {13.473, 1.782, 1.596, 1.550, 0.257},
         {14.326, 1.921, 1.730, 1.675, 0.284},
         {15.200, 2.065, 1.864, 1.804, 0.319},
         {16.105, 2.216, 2.007, 1.940, 0.355},
         {16.939, 2.373, 2.155, 2.080, 0.393},
         {17.998, 2.532, 2.307, 2.223, 0.430},
         // Z=41-50 - continue pattern
         {18.986, 2.698, 2.465, 2.371, 0.468},
         {20.000, 2.866, 2.625, 2.520, 0.506},
         {21.044, 3.043, 2.793, 2.677, 0.544},
         {22.117, 3.224, 2.967, 2.838, 0.586},
         {23.220, 3.412, 3.146, 3.004, 0.628},
         {24.350, 3.604, 3.330, 3.173, 0.669},
         {25.514, 3.806, 3.524, 3.351, 0.717},
         {26.711, 4.018, 3.727, 3.538, 0.766},
         {27.940, 4.237, 3.938, 3.734, 0.816},
         {29.200, 4.465, 4.156, 3.938, 0.868},
         // Z=51-60 - continue pattern
         {30.491, 4.698, 4.380, 4.132, 0.946},
         {31.814, 4.939, 4.612, 4.341, 1.006},
         {33.169, 5.188, 4.852, 4.557, 1.097},
         {34.561, 5.453, 5.107, 4.786, 1.161},
         {35.985, 5.723, 5.367, 5.012, 1.241},
         {37.441, 6.005, 5.636, 5.247, 1.293},
         {38.925, 6.295, 5.914, 5.489, 1.362},
         {40.443, 6.602, 6.205, 5.744, 1.436},
         {41.991, 6.910, 6.498, 6.003, 1.511},
         {43.569, 7.243, 6.835, 6.298, 1.576},
         // Z=61-70 - continue pattern
         {45.184, 7.575, 7.170, 6.596, 1.650},
         {46.834, 7.930, 7.514, 6.904, 1.723},
         {48.519, 8.294, 7.867, 7.221, 1.800},
         {50.239, 8.668, 8.230, 7.547, 1.878},
         {51.996, 9.051, 8.601, 7.881, 1.959},
         {53.789, 9.442, 8.981, 8.224, 2.040},
         {55.618, 9.842, 9.370, 8.576, 2.125},
         {57.486, 10.259, 9.773, 8.944, 2.216},
         {59.390, 10.682, 10.182, 9.318, 2.307},
         {61.332, 11.116, 10.602, 9.704, 2.398},
         // Z=71-80 - continue pattern
         {63.314, 11.559, 11.031, 10.097, 2.491},
         {65.351, 12.020, 11.480, 10.510, 2.601},
         {67.416, 12.493, 11.938, 10.932, 2.708},
         {69.525, 12.973, 12.404, 11.364, 2.819},
         {71.676, 13.469, 12.884, 11.812, 2.937},
         {73.871, 13.977, 13.376, 12.271, 3.058},
         {76.111, 14.498, 13.880, 12.740, 3.181},
         {78.395, 15.032, 14.398, 13.223, 3.309},
         {80.725, 15.578, 14.928, 13.718, 3.442},
         {83.102, 16.138, 15.472, 14.226, 3.579},
         // Z=81-90 - continue pattern
         {85.530, 16.716, 16.035, 14.756, 3.730},
         {88.005, 17.303, 16.607, 15.294, 3.879},
         {90.526, 17.901, 17.191, 15.845, 4.033},
         {93.105, 18.521, 17.795, 16.419, 4.205},
         {95.730, 19.150, 18.408, 17.001, 4.380},
         {98.404, 19.794, 19.036, 17.600, 4.561},
         {101.137, 20.464, 19.693, 18.230, 4.766},
         {103.922, 21.148, 20.361, 18.871, 4.974},
         {106.755, 21.849, 21.045, 19.530, 5.189},
         {109.651, 22.581, 21.762, 20.230, 5.435},
         // Z=91-100 - final elements
         {112.601, 23.340, 22.507, 20.959, 5.699},
         {115.606, 24.121, 23.269, 21.707, 5.971},
         {118.678, 24.931, 24.063, 22.491, 6.268},
         {121.818, 25.775, 24.885, 23.305, 6.584},
         {125.027, 26.644, 25.733, 24.146, 6.914},
         {128.312, 27.544, 26.612, 25.020, 7.264},
         {131.678, 28.484, 27.530, 25.935, 7.640},
         {135.137, 29.470, 28.497, 26.902, 8.052},
         {138.688, 30.504, 29.514, 27.922, 8.496},
         {142.343, 31.588, 30.583, 28.997, 8.975}}};

double
ScofieldPhotoelectricData::getPhotoelectricCrossSection(int Z,
                                                        double energy_keV)
{
  if(Z < 1 || Z > 100)
  {
  ...
  {
    cross_section +=
        calculateLShellCrossSection(Z, energy_keV, binding.L1_edge, 1);
  }
  if(energy_keV >= binding.L2_edge && binding.L2_edge > 0.0)
  {
    cross_section +=
        calculateLShellCrossSection(Z, energy_keV, binding.L2_edge, 2);
  }
  if(energy_keV >= binding.L3_edge && binding.L3_edge > 0.0)
  {
    cross_section +=
        calculateLShellCrossSection(Z, energy_keV, binding.L3_edge, 3);
  }
  ...
  {
    cross_section +=
        calculateMShellCrossSection(Z, energy_keV, binding.M1_edge);
  }

  return cross_section; // Returns in barns
}

double ScofieldPhotoelectricData::calculateKShellCrossSection(int Z,
                                                              double energy_keV,
                                                              double edge_keV)
{
  if(energy_keV < edge_keV)
    return 0.0;
  ...
  double r_e_squared = Constants::CLASSICAL_ELECTRON_RADIUS_CM *
                       Constants::CLASSICAL_ELECTRON_RADIUS_CM;

  // Simplified Scofield formula (approximate)
  double sigma_K = (32.0 * M_PI / 3.0) * r_e_squared * std::pow(alpha * Z, 4) *
                   std::pow(eta, -3.5);
...
double ScofieldPhotoelectricData::calculateLShellCrossSection(int Z,
                                                              double energy_keV,
                                                              double edge_keV,
                                                              int subshell)
{
  ...
  case 1:
    ...
    break; // L1: 2 electrons
  case 2:
    occupancy_factor = 2.0;
    break; // L2: 2 electrons
  case 3:
    occupancy_factor = 4.0;
    break; // L3: 4 electrons
  }

  // L-shell cross-section (approximately 1/4 of K-shell per electron)
  double sigma_L = (8.0 * M_PI / 3.0) * r_e_squared * std::pow(alpha * Z, 4) *
                   std::pow(eta, -3.5) * occupancy_factor;

  return sigma_L * 1e24; // Convert to barns
}

double ScofieldPhotoelectricData::calculateMShellCrossSection(int Z,
                                                              double energy_keV,
                                                              double edge_keV)
{
  if(energy_keV < edge_keV)
  ...
  // M-shell typically has ~18 electrons for heavy elements, approximate
  // cross-section
  double occupancy_factor = 18.0;
  double sigma_M = (2.0 * M_PI / 3.0) * r_e_squared * std::pow(alpha * Z, 4) *
                   std::pow(eta, -3.5) * occupancy_factor;

  return sigma_M * 1e24; // Convert to barns
}

bool ScofieldPhotoelectricData::isAboveAbsorptionEdge(int Z, double energy_keV,
                                                      char shell)
{
  if(Z < 1 || Z > 100)
    return false;
  ...
  {
  case 'K':
    return energy_keV >= binding.K_edge;
  case 'L':
    return energy_keV >= binding.L1_edge; // Use L1 as representative
  case 'M':
    return energy_keV >= binding.M1_edge;
  default:
    return false;
  }
}
...
double ScofieldPhotoelectricData::getBindingEnergy(int Z, char shell)
{
  ...
  {
  case 'K':
    return binding.K_edge;
  case 'L':
    return binding.L3_edge; // L3 is most common
  case 'M':
    return binding.M1_edge;
  default:
    return 0.0;
  }
}
...
const std::array<AtomicFormFactor, 100>
    CoherentScatteringData::FORM_FACTOR_DATA = {{
        // Z=1: Hydrogen
        {{0.489918, 0.262003, 0.196767, 0.049879},
         {20.6593, 7.74039, 49.5519, 2.20159},
         0.001305},
        // Z=2: Helium
        {{0.873400, 0.630900, 0.311200, 0.178000},
        ...
        {{1.5919, 1.1278, 0.5391, 0.7029},
         {43.6427, 1.8623, 103.483, 0.5420},
         0.0385},
        // Z=5: Boron
        {{2.0545, 1.3326, 1.0979, 0.7068},
         {23.2185, 1.0210, 60.3498, 0.1403},
         -0.1932},
        // Z=6: Carbon
        ...
        {{3.9553, 3.1125, 1.4546, 1.1251},
         ...
         0.3515},
        // Continue for Z=11-100 (abbreviated for space - using simplified
        // approximations)
...
double CoherentScatteringData::getCoherentCrossSection(int Z, double energy_keV)
{
  ...
  if(Z > 10)
  {
    // Approximation: coherent cross-section scales roughly as Z²/E for high
    // energies This gives reasonable estimates for heavy elements
    double energy_MeV = energy_keV / 1000.0;
    double approx_cross_section =
        sigma_thomson * Z * Z * std::pow(energy_MeV, -0.2) * 0.01;
    return std::max(0.0, approx_cross_section);
  }

  // For Z <= 10, use the detailed form factor calculation
  // Momentum transfer parameter
  double lambda_cm = Constants::HBAR_C_KEV_FEMTOMETER * 1e-13 /
                     energy_keV;  // Compton wavelength
...
double CoherentScatteringData::getAtomicFormFactor(int Z,
...
double CoherentScatteringData::calculateFormFactor(const AtomicFormFactor &ff,
                                                   double q)
{
...
double
PairProductionData::getPairProductionNuclearCrossSection(int Z,
                                                         double energy_MeV)
{
  ...
  // Based on Evans "The Atomic Nucleus" and Turner "Atoms, Radiation, and
  ...
  if(k > 5.0)
  {
    ...
    double cross_section =
        (28.0 / 9.0) * alpha * r_e * r_e * Z_factor * (log_term - 1.0 / 42.0);
  ...
  else
  {
    ...
    double cross_section =
        alpha * r_e * r_e * Z_factor * energy_factor * std::log(2.0 * k);
...
double
PairProductionData::getPairProductionElectronCrossSection(int Z,
                                                          double energy_MeV)
{
  if(!isPairProductionPossible(energy_MeV))
  {
...
double PairProductionData::getTotalPairProductionCrossSection(int Z,
                                                              double energy_MeV)
{
...
PairProductionData::calculateScreeningFunctions(int Z, double energy_MeV)
{
...
double
IncoherentScatteringData::getTotalIncoherentCrossSection(int Z,
                                                         double energy_keV)
{
  ...
  double binding_correction =
      1.0 - 0.1 * std::pow(Z, 0.5) / std::sqrt(energy_keV);
...
double IncoherentScatteringData::getKleinNishinaCrossSection(double energy_keV)
{
  ...
  double term2 = (2.0 * alpha * (1.0 + alpha)) / (1.0 + 2.0 * alpha) -
                 std::log(1.0 + 2.0 * alpha);
...
std::array<double, 5>
PhotonInteractionDatabase::getAllCrossSections(int Z, double energy_keV)
{
  std::array<double, 5> cross_sections;

  // [0] Photoelectric
  cross_sections[0] =
      ScofieldPhotoelectricData::getPhotoelectricCrossSection(Z, energy_keV);

  // [1] Coherent (Rayleigh)
  cross_sections[1] =
      CoherentScatteringData::getCoherentCrossSection(Z, energy_keV);

  // [2] Incoherent (Compton)
  cross_sections[2] =
      IncoherentScatteringData::getTotalIncoherentCrossSection(Z, energy_keV);

  // [3] Pair production (nuclear)
  double energy_MeV = keVToMeV(energy_keV);
  cross_sections[3] =
      PairProductionData::getPairProductionNuclearCrossSection(Z, energy_MeV);

  // [4] Pair production (electronic)
  cross_sections[4] =
      PairProductionData::getPairProductionElectronCrossSection(Z, energy_MeV);

  return cross_sections;
}

double PhotonInteractionDatabase::getMassAttenuationCoefficient(
    int Z, double atomic_mass, double energy_keV)
{
